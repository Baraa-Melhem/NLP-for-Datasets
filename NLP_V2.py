...
#reading data
data=pd.read_csv(r"Data_path", encoding='latin-1')
data.columns
...
data.rename(columns={'column_name ': 'Name_to_replace'}, inplace=True) #rename columns
...
####
dataaf.to_csv(r"saving_the_new_Data_to_save_your_progress",index=False)


dataaf=pd.read_csv(r"New_Data_Path")
